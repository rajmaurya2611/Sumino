...
// import motionImage2 from "../../assets/Homepage/Group 5836.png"; // Adjust the path as necessary

// const FirstComponent: React.FC = () => {
//   return (
//     <div className=" bg-[#ECF7FB] font-montserrat flex flex-col md:flex-row items-center justify-between bg-white pt-20 px-6 md:px-16">
//       {/* Left: Text Section */}
//       <div className="pl-6 md:w-1/2 space-y-6">
//         <h1 className="font-semibold text-[#183B56]  text-5xl text-gray-800">
//           We Craft ;<br />
//           Deploy & Create<br />
//          Scalable Apps
//         </h1>
...
//       {/* Right: Image Section */}
//             <div className="md:w-1/2 mt-8 md:mt-0 relative flex justify-center items-center h-full">
//         {/* Main landing illustration (base layer) */}
//         <img
//           src={landingImage}
...
//           src={motionImage2}
//           alt="Top Decoration"
//           className="absolute top-30 right-28 w-1/6 max-w-sm z-10 animate-float-slow"
//         />
//       </div>
//     </div>
//   );
